import { address, ART_GOBBLER_ABI, ALOE_TOKEN_ABI } from './config'
...
const ALOE_TOKEN_ADDRESS = "0x49c7323d0EE80478e78c20e147865f5A36cEa070"
...
const getTokenBalance = async (w3, userAddress) => {
    const address = ALOE_TOKEN_ADDRESS
    const contract = loadContract(w3, address, ALOE_TOKEN_ABI)
...
const mintToken = async (w3, userAddress, amount) => {
    const address = ALOE_TOKEN_ADDRESS
    const contract = loadContract(w3, address, ALOE_TOKEN_ABI)
